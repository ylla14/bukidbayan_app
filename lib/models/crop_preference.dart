...
const Map<String, List<String>> cropToolTypes = {
  ...
  'White Corn': [
    'Tractor', 'Implements', 'Hand Tractor (Kuliglig)', 'Machine', 'Hand Tool', 'Harvester (Halimaw)',
  ],
  'Squash/Upo': [
    'Hand Tractor (Kuliglig)', 'Tractor', 'Implements', 'Machine', 'Hand Tool',
  ],
  'Leafy/Small Vegetables': [
    'Hand Tractor (Kuliglig)', 'Machine', 'Hand Tool',
  ],
  'Watermelon': [
    'Tractor', 'Implements', 'Hand Tractor (Kuliglig)', 'Machine', 'Hand Tool',
  ],
};
